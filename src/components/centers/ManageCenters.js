  ...
  return (
    <div className="d-flex ">
      ...
      <div className="col-10 p-0">
        ...
        <Link to='/' className="text-decoration-none"><i className="bi bi-house-fill"></i>&nbsp;Home&nbsp;</Link>&gt; Centers &gt; Manage Centers
        </nav>
          ...
          >
            ...
            <tbody>
              <tr role="row" className="odd">
                ...
                <td className="hidden-480">Hyderabad</td>
                <td className="hidden-480">08:00AM - 08:00PM</td>
              ...
              <tr role="row" className="even">
                ...
                <td className="hidden-480">Agra</td>
                <td className="hidden-480">02:00AM - 01:00PM</td>
