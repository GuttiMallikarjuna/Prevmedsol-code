      ...
      >
        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body p-0">
              <ul className="list-group">
                <Link to='/addPatient' className="text-decoration-none text-dark"><li className="list-group-item">View Payments</li></Link>
                <Link to='/addPatient' className="text-decoration-none text-dark"><li className="list-group-item">Invoice</li></Link>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body p-0">
              <ul className="list-group">
                <Link to='/addPatient' className="text-decoration-none text-dark"><li className="list-group-item">Site Managers</li></Link>
                <Link to='/addPatient' className="text-decoration-none text-dark"><li className="list-group-item">Patients</li></Link>
                <Link to='/addPatient' className="text-decoration-none text-dark"><li className="list-group-item">Doctors</li></Link>
                <Link to='/addPatient' className="text-decoration-none text-dark"><li className="list-group-item">Lab Agents</li></Link>
              </ul>
            </div>
          </div>
        </div>
